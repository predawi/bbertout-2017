	...
	<div class="wrapper main-content" id="main-content">
		...
		<section id="works" class="base-section">
			...
			<div class="highlight__project highlight__project--alt">
				<a href="https://hautsdefrance.cci.fr/" target="_blank"><img src="../assets/img/cci-hauts-de-france-thumb.jpg" data-img="cci-hauts-de-france-thumb" alt="" class="highlight__project__img"></a>
				<h2 class="highlight__project__title">
			...
			<div class="highlight__project">
				<a href="https://sapeurs-pompiers35.fr/" target="_blank"><img src="../assets/img/sdis-35-thumb.jpg" data-img="sdis-35-thumb" alt="" class="highlight__project__img"></a>
				<h2 class="highlight__project__title">
